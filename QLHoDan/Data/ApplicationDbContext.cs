...
public class ApplicationDbContext : ApiAuthorizationDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MovingOutForm>()
            .HasOne<Resident>(nk => nk.Resident).WithOne()
            .OnDelete(DeleteBehavior.NoAction)
        ...
        //modelBuilder.Entity<THForm>().Property<int>("ChuHoMoiId");
        modelBuilder.Entity<SplitingHouseholdForm>().HasMany<Resident>(nk => nk.Residents).WithOne();
        ...
        modelBuilder.Entity<SplitingHouseholdForm>()
            .HasOne<Resident>(nk => nk.Owner).WithOne()
            .OnDelete(DeleteBehavior.NoAction)
        ...
        modelBuilder.Entity<ChangingHouseholdInfoForm>()
            .HasOne<Household>(nk => nk.Household).WithOne()
            .OnDelete(DeleteBehavior.NoAction)
        ...
        modelBuilder.Entity<ChangingHouseholdForm>()
            .HasOne<Household>(nk => nk.NewHousehold).WithOne()
            .OnDelete(DeleteBehavior.NoAction)
        ...
        modelBuilder.Entity<RewardRecord>()
            .HasOne<RewardCeremony>(ls => ls.RewardCeremony).WithOne()
            .OnDelete(DeleteBehavior.NoAction)
            .HasForeignKey<RewardRecord>("RewardCeremonyId");
        modelBuilder.Entity<RewardRecord>()
            .HasOne<Resident>(ls => ls.Resident).WithOne()
            .OnDelete(DeleteBehavior.NoAction)
